class BankAccount {
  ...
  withdraw(amount) {
    if (amount < 0) {
      throw new NegativeAmount('The amount provided cannot be negative'); // Use custom Error class
    }

    if (this.#amount < amount) {
      throw new MoreThanBalance('You cannot withdraw more than account balance'); // Use custom Error class
    }
